...
namespace MCLawl
{
    public class Server
    {
        ...
        public static List<string> devs = new List<string>(new string[] { "KDY9111, SoySauceChips, Weasels30" });
        ...
        public static string name = "[MCDark] Default";
