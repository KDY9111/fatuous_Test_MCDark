    ...
    public partial class Window : Form
    {
      ...
      /*     if (!Minimized)
        ...
        private void Window_Load(object sender, EventArgs e) {
            ...
            s.Start();
            notifyIcon1.Text = ("MCDark Server: " + Server.name);
        ...
        void SettingsUpdate()
        {
            ...
            if (txtLog.InvokeRequired)
            {
                ...
                this.Text = Server.name + " MCDark Version: " + Server.Version;
            }
        }
        ...
        {
            MessageBox.Show("Checkforupdates function will be added here Derp");
        }
